...
from SpideyRobot import OWNER_ID
...
async def lego(event):
 ...
 try:
    ...
    draw.text((x, y), text, font=font, fill="black", stroke_width=10, stroke_fill="#F9484A")
...
async def lego(event):
 ...
 try:
    ...
    x = (image_widthz-w)/2
    y= ((image_heightz-h)/2+6)
    draw.text((x, y), text, font=font, fill="white", stroke_width=0, stroke_fill="#F9484A")
    fname2 = "SpideyLogo.png"
    img.save(fname2, "png")
